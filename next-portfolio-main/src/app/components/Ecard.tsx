    ...
    return (
        <CardContainer className="inter-var">
            <CardBody className="relative group/card hover:shadow-2xl hover:shadow-emerald-500/[0.1] bg-black border-white/[0.2] w-auto sm:w-[27rem] rounded-xl p-6 border">
                ...
                >
                    A clean, intuitive eCommerce user interface crafted to enhance
                    the online shopping experience. With easy navigation and product
                    displays, this project prioritizes user engagement and accessibility.
                </CardItem>
